            ...
            <div className='w-full'>
                ...
                <div className="content">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Card icon={<FiLayers size={30} />} title='Today Order' price={OrderReport? 30 :0} currency="" bg_color='#0694A2' />
                        <Card icon={<FiShoppingCart size={30} />} title='This Month' price={OrderReport? 48:0} currency="" bg_color='#3F83F8' />
                        <Card icon={<FiDollarSign size={30} />} title='Total Order' price={OrderReport? OrderReport.TotalOrders:0} currency="USD" bg_color='#0E9F6E' />
                    </div>
